...
private:
	...
	GLvoid __loadTextureFromMaterial(aiTextureType vTextureType, const aiMaterial *vMat, const std::string& vTextureNamePrefix, std::vector<SMeshTexture>& voTextures, std::shared_ptr<hiveGraphics::STexture> vTexture2D = std::make_shared<hiveGraphics::STexture>());
};