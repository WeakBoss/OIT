...
public:
	...
	const hiveGraphics::MVector<std::shared_ptr<IRenderPass>>&  getRenderPassSet() const { return m_RenderPassSet; }
	const hiveGraphics::MVector<std::shared_ptr<IGameObject>>&  getGameObjectSet() const { return m_GameObjectSet; }
	const hiveGraphics::MVector<std::shared_ptr<IGUI>>&			getSubGUISet() const { return m_SubGUISet; }
...
private:
	...
	hiveGraphics::MVector<std::shared_ptr<IRenderPass>> m_RenderPassSet;
	hiveGraphics::MVector<std::shared_ptr<IGameObject>> m_GameObjectSet;
	hiveGraphics::MVector<std::shared_ptr<IGUI>>		m_SubGUISet;
