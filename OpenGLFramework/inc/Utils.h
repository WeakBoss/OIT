...
FRAME_DLLEXPORTS GLvoid genTexture(std::shared_ptr<hiveGraphics::STexture> vioTexture/* = HiveGraphics::STexture()*/);
...
FRAME_DLLEXPORTS GLint  createVAO4CubeVolume();
FRAME_DLLEXPORTS void   drawQuad();
FRAME_DLLEXPORTS void   drawCube();
FRAME_DLLEXPORTS void   drawSphere();
FRAME_DLLEXPORTS GLint  genFBO(const std::initializer_list<std::shared_ptr<hiveGraphics::STexture>>& vioTextureAttachments);
...
FRAME_DLLEXPORTS void   blitFrameBufferTexture(std::shared_ptr<hiveGraphics::STexture> vioSrcTexture, std::shared_ptr<hiveGraphics::STexture> vioDestTexture, GLenum vFilter = GL_NEAREST, std::array<bool, 4> vChannels = { true, true, true, true});
