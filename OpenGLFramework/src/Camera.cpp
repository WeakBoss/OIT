...
{
	return glm::perspective(glm::radians(m_Fov), (GLdouble)hiveGraphics::WINDOW_KEYWORD::WINDOW_WIDTH / (GLdouble)hiveGraphics::WINDOW_KEYWORD::WINDOW_HEIGHT, m_Near, m_Far);
}
