...
IGUI::IGUI(const std::string& vName, int vExecutionOrder) : m_Name(vName), m_ExecutionOrder(vExecutionOrder)
{
}
...
//************************************************************************************
//Function:
bool IGUI::sliderScalar(const std::string& vLable, hiveGraphics::EDataType vDataType, void* vValue, const void* vMin, const void* vMax, const char* vFormat)
{
	return ImGui::SliderScalar(vLable.c_str(), static_cast<int>(vDataType), vValue, vMin, vMax, vFormat);
}

//************************************************************************************
//Function:
bool IGUI::sliderScalarN(const std::string& vLable, hiveGraphics::EDataType vDataType, int vComponentsNum, void* vValue, const void* vMin, const void* vMax)
{
...
//************************************************************************************
//Function:
bool IGUI::dragScalar(const std::string& vLabel, hiveGraphics::EDataType vDataType, void* vValue, float vDragSpeed, const void* vMin, const void* vMax)
{
...
//************************************************************************************
//Function:
bool IGUI::dragScalarN(const std::string& vLabel, hiveGraphics::EDataType vDataType, void* vValue, int vComponentsNum, float vDragSpeed, const void* vMin, const void* vMax)
{
...
//************************************************************************************
//Function:
void IGUI::pushStyleColor(hiveGraphics::EGUIItemColor vItemColor, const glm::vec4& vColor)
{
