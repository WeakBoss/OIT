...
std::string CShader::__loadShaderSourceFromFile(const std::string& vShaderFileName) const
{
	try
	{
		...
		return __readShaderFile(vShaderFileName);
	}
...
//************************************************************************************
//Function:
std::string CShader::__readShaderFile(const std::string& vShaderFileName) const
{
	std::string FullShaderText = "";
	std::ifstream ShaderFile(vShaderFileName);
	_ASSERTE(ShaderFile);
	...
	while (std::getline(ShaderFile, LineBuffer))
	{
		...
		if (LineBuffer.find(IncludeIndentifier) != LineBuffer.npos)
		{
			...
			getFilePath(vShaderFileName, pathOfThisFile);
...
//************************************************************************************
//Function:
GLboolean CShader::link(GLsizei vCount, const char** vpVaryings, GLenum vMode) const
{
	_ASSERT(m_ShaderProgram);
	if (vCount && vpVaryings)
		glTransformFeedbackVaryings(m_ShaderProgram, vCount, vpVaryings, vMode);

	return __linkProgram();
}
...
//************************************************************************************
//Function:
GLvoid CShader::setTextureUniformValue(const std::string& vTextureUniformName, const std::shared_ptr<hiveGraphics::STexture>& vioTextureConfig)
{
...
//************************************************************************************
//Function:
GLvoid CShader::setImageUniformValue(const std::shared_ptr<hiveGraphics::STexture>& vTextureConfig)
{
